    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pending Donation Submissions</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  if($query1->getNumRows() >= 1){
                    ...
                    foreach ($query1->getResult() as $row1) {
                      ...
                      if($row1->active == "P"){
                        ...
                        <button type="button" class="btn btn-primary btn_approve" attr="'.$row1->id.'">Approve</button> &nbsp
                        <button type="button" class="btn btn-danger btn_reject" attr="'.$row1->id.'">Reject</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="btn_reject" attr="">Reject</button>
