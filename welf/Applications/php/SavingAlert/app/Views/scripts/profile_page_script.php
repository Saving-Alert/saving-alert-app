...
<script>
    ...
    $(document).on("click", "#saveProfname", function(){
        ...
        $.ajax({
            ...
            type 	: 'post',
            data 	: {"my_name_is": my_name_is, "nic":nic, "dob":dob, "gender":gender, "blood_group":blood_group, "weight":weight, "height":height, "diseases":diseases, "health_status":health_status},
            dataType : "json",
            cache   : false,
            processData: true,
            beforeSend:function(){
