...
$builder->where("dontation_type", "R");
            ...
            <div class="col-lg-6">
                <div class="breadcrumb_content style2 mb0-991">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active text-thm" aria-current="page">Requests</li>
                    </ol>
                    <h2 class="breadcrumb_title">Donation Requests</h2>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="grid_list_search_result style2">
                        <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3">
                            <div class="left_area">
                                <p><?php echo $query->getNumRows() ?> results</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    if($query->getNumRows() >= 1){
                        ...
                        foreach ($query->getResult() as $row) {
                            ...
                            if($row->active == "P" || $row->active == "D" || $row->active == "S"){
                                continue;
                            }

                            $food_type = $row->food_type == "D" ? "Dry Food" : "Coocked Food";
                            ...
                            echo '
										...
										<div class="feat_property home7 agency btn_claim" attr="'.$row->id.'">
											...
											<div class="details">
												...
												<div class="fp_footer">
													...
													<li class="list-inline-item">District : '.$row->area_1.'</li>
													<li class="list-inline-item">City/Area : '.$row->area_2.'</li>
									...
									';
                            // <div class="fp_pdate float-right text-thm"><button type="button" class="btn btn-info btn_claim" attr="'.$row->id.'">Claim Donaton</button></div>
                        }
...
<div class="req_details_mod modal fade " tabindex="-1" role="dialog" aria-hidden="true">
