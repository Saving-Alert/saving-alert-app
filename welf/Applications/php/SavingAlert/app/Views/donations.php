				...
				<div class="col-lg-6">
					<div class="breadcrumb_content style2 mb0-991">
						<ol class="breadcrumb">
						    ...
						    <li class="breadcrumb-item active text-thm" aria-current="page">Donations</li>
						</ol>
						<h2 class="breadcrumb_title">Donations</h2>
					</div>
				</div>
				<div class="col-lg-6">
						...
						<?php
							...
							if($query->getNumRows() >= 1){
								...
								foreach ($query->getResult() as $row) {
									...
									$food_type = $row->food_type == "D" ? "Dry Food" : "Cooked Food";
